...
const Clips = ({ clip, imgsrc }) => {
  return (
    <div className="relative h-28 w-32 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14">
      ...
      />
      <div className="h-full w-full flex items-center justify-center border-red-400 z-50 group-hover:opacity-0">
        <div className="bg-white blur-effect-theme  opacity-100 z-[100] w-8 h-8 md:w-5 md:h-5 flex items-center justify-center rounded-full">
      ...
      <video
        ...
        muted={true}
        playsInline={true}
        className="absolute top-0 left-0 right-0 flex h-full w-full object-cover opacity-0 z-0 group-hover:z-50 group-hover:opacity-100 rounded-xl"
      >
